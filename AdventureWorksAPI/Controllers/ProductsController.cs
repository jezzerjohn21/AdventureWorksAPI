...
namespace AdventureWorksAPI.Controllers
{
	...
	public class ProductsController : ControllerBase
	{
		...
		[HttpGet]
		[Route("GetProductByNameWithoutQueryExpressionsInGenericway/{productname}")]
		...
		*/
		...
		[HttpGet]
		[Route("GetProductByProductNumer/{productnumber}")]
		...
		[HttpGet]
		[Route("GetProductByProductNameAndProductNumber")]
